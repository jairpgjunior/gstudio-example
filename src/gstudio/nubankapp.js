      ...
      <div className="nubankapp">
          <div className="nubankapp-nubankmobile-5">
              <div className="nubankapp-0-0">
                  ...
                  <div className="nubankapp-0-0-1">
                      <div className="nubankapp-0-0-1-0">
                          <div className="nubankapp-line-9" /> 
                      </div>
                      <div className="nubankapp-0-0-1-1">
                          <div className="nubankapp-line-6" /> 
                      </div>
                  </div>
                  <div className="nubankapp-0-0-2" /> 
              </div>
              ...
              <div className="nubankapp-0-2">
                  <div className="nubankapp-rectangle_6">
                      <div className="nubankapp-0-2-0-0">
                          <div className="nubankapp-nuconta_-3">NuConta</div>
                      </div>
